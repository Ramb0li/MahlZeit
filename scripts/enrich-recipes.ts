...
// ---------------------------------------------------------------------------
// EU-Allergen → Keyword-Arrays
// ---------------------------------------------------------------------------

const EU_ALLERGEN_MAP: Record<EuAllergen, string[]> = {
...
const EU_ALLERGEN_KEYS = Object.keys(EU_ALLERGEN_MAP) as EuAllergen[];

// ---------------------------------------------------------------------------
// Allergen-Berechnung (synchron, kein API-Call)
// ---------------------------------------------------------------------------
...
function computeAllergens(recipe: RecipeLike): EuAllergen[] {
